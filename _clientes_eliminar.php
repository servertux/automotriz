...
<div class="flexbox">
  ...
  <div class="col-lg-6">
     ...
     <p><h3> Actualizar/Borrar Clientes</h3></p>
    ...
    if(strlen($query) >= $min_length){ 
        ...
        if(mysql_num_rows($raw_results) > 0){ 
          ...
          <tr>
                  ...
                  <td><?php echo $results['id_clientes'];?></td>
                 
                  
                  <td><a href="clientes/BorrarCliente.php?cadena=<?php echo $results['id_clientes'];?>" onclick="return confirm_delete()" > <img src="images/_delete.png">Eliminar</a></td>
                  <td><a href="ActualizarCliente.php?cadena=<?php echo $results['id_clientes'];?>"><img src="images/write.png">Modificar</a></td>
