...
<h3><span class="label label-info">Reporte de Entradas y Salidas</span></h3>
	</div>
</div>
...
$result = mysqli_query($con,"Select * From movimiento WHERE DATE(fecha)  BETWEEN  '$fechamin' AND '$fechamax';");
